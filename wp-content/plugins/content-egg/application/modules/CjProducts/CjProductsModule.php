...
class CjProductsModule extends AffiliateParserModule {
    ...
    public static function updateNotice()
    {
        ...
        echo '<p>' . sprintf(__('CJ launched a new Product Search API. Please visit <a href="%s">CJ Product settings</a> to get started with the new API.', 'content-egg'), \get_admin_url(\get_current_blog_id(), 'admin.php?page=content-egg--CjProducts')) . '</p>';
        echo '</div>';
    }
