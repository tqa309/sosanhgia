...
class EbayConfig extends AffiliateParserModuleConfig {
    ...
    public function options()
    {
        $optiosn = array(
            'app_id' => array(
                'title' => 'Application ID (AppID) <span class="cegg_required">*</span>',
                'description' => __('API access key to Ebay. You can get it in <a href="http://developer.ebay.com/join">eBay Developers Program</a>.', 'content-egg'),
                ...
                'validator' => array(
                    ...
                    array(
                        ...
                        'when' => 'is_active',
                        'message' => __('Field "Application ID (AppID)" can\'t be empty', 'content-egg'),
                    ),
                ),
                'section' => 'default',
            ),
            ...
            //@link: https://accounts.skimlinks.com/linkapi
            ...
            'sort_order' => array(
                ...
                'description' => '',
                'callback' => array($this, 'render_dropdown'),
                'dropdown_options' => array('BidCountFewest' => 'BidCountFewest', 'BidCountMost' => 'BidCountMost', 'BestMatch' => 'BestMatch', 'CurrentPriceHighest' => 'CurrentPriceHighest', 'EndTimeSoonest' => 'EndTimeSoonest', 'PricePlusShippingHighest' => 'PricePlusShippingHighest', 'PricePlusShippingLowest' => 'PricePlusShippingLowest', 'StartTimeNewest' => 'StartTimeNewest', 'WatchCountDecreaseSort' => 'WatchCountDecreaseSort'),
                'default' => 'BestMatch',
                'section' => 'default',
            ),
            'end_time_to' => array(
            ...
            'search_logic' => array(
                ...
                'callback' => array($this, 'render_dropdown'),
                'dropdown_options' => array('AND' => 'AND logic for multiple keywords', 'OR' => 'OR logic for multiple keywords', 'EXACT' => 'Exact sequence of words'),
                'default' => 'AND',
                'section' => 'default',
            ),
            'condition' => array(
                ...
                'description' => '',
                'callback' => array($this, 'render_dropdown'),
                'dropdown_options' => array('' => 'Any', '1000,' => 'New', '1000,2000,2500' => 'New + Refurbished', '3000,' => 'Used', '3000,2000,2500' => 'Used + Refurbished',
            ...
            'feedback_score_min' => array(
                ...
                'description' => '',
                'callback' => array($this, 'render_dropdown'),
                'dropdown_options' => array('' => 'Any', '10.' => 'Yellow star - 10 ratings', '50.' => 'Blue star - 50 rating', '100.' => 'Turquoise star - 100 rating', '500.' => 'Purple star - 500 rating', '1000.' => 'Red star - 1,000 rating', '5000.' => 'Green star - 5,0000 ratings', '10000.' => 'Yellow shooting star - 10,000', '25000.' => 'Turquoise shooting star - 25000', '50000.' => 'Purple shooting star - 50,000', '100000.' => 'Red shooting star 100,000', '500000.' => 'Green shooting star - 500,000', '1000000.' => 'Silver shooting star - 1,000,000'),
                'default' => '',
                'section' => 'default',
            ),
            ...
            'hide_dublicate_items' => array(
                'title' => __('Hide dublicates', 'content-egg'),
