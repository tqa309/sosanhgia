	...
	class Rehub_Admin{
		...
		function rehub_admin_scripts() {
			...
			<?php if(rehub_option('rehub_body_font')) : ?>
				.editor-styles-wrapper .wp-block, .editor-styles-wrapper .wp-block-heading, .editor-styles-wrapper .editor-post-title__block .editor-post-title__input, .editor-styles-wrapper blockquote.is-style-large, .editor-styles-wrapper .wp-block-button .wp-block-button__link {
			...
			<?php if(rehub_option('rehub_headings_font')) : ?>
				.editor-styles-wrapper .editor-post-title__block .editor-post-title__input, .editor-styles-wrapper h1.wp-block, .editor-styles-wrapper h2.wp-block, .editor-styles-wrapper h3.wp-block, .editor-styles-wrapper h4.wp-block, .editor-styles-wrapper h5.wp-block, .editor-styles-wrapper h6.wp-block, .wp-block-quote.is-style-large{
			...
			.wp-block-quote:not(.is-large):not(.is-style-large), .wp-block-pullquote, .rehub-main-color-border{border-color: <?php echo ''.$maincolor; ?>;}
			.rehub-sec-color-bg,
...
function rh_standard_wp_pages_styles() { ?>
    ...
    <style type="text/css">
    	...
    	<?php endif;?>
    	body.login.wp-core-ui .button-group.button-large .button, body.login.wp-core-ui .button.button-large{
			padding:4px; font-size:18px; width:100%;
		}
		<?php if($btn):?>
			body.login.wp-core-ui .button-group.button-large .button, body.login.wp-core-ui .button.button-large{background: <?php echo esc_attr($btn);?>; border-color:transparent}
		<?php endif;?>
		<?php if($btntxt):?>
			body.login.wp-core-ui .button-group.button-large .button, body.login.wp-core-ui .button.button-large{color: <?php echo esc_attr($btntxt);?>; }
		<?php endif;?>
    </style>
<?php }
