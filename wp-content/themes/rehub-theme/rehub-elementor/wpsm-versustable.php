...
class WPSM_Versus_Line_Widget extends Widget_Base {
    ...
    protected function render() {
        ...
        $settings['firstcolumnimg'] = $settings['firstcolumnimg']['id'];
        $settings['secondcolumnimg'] = $settings['secondcolumnimg']['id'];
        $settings['thirdcolumnimg'] = $settings['thirdcolumnimg']['id'];
