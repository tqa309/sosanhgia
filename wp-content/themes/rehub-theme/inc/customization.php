...
<?php if(rehub_option('rehub_headings_font')) : ?>
	...
	.title h5,
	.comment-respond h3{
		<?php if(rehub_option('rehub_headings_font_weight')) : ?>font-weight:<?php echo rehub_option('rehub_headings_font_weight'); ?>;<?php endif; ?>
...
.dark_body #rh_p_l_fullwidth_opt .rh-post-excerpt{color: #fff;}
...
.dark_body #rh_p_l_fullwidth_opt .title_single_area .post-meta{color: #eee}
