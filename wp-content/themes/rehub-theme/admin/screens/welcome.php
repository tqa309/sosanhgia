    ...
    <div class="feature-section">
		<div class="rehub-important-notice registration-form-container">
			...
			<?php if(!$registeredlicense) : ?>
				<?php if(!empty($activationmessage)):?>
					...
					<?php if(stripos($activationmessage, 'License is already active on maximum') === 0 && $licode && $liuser):?>
						<style>
							.rehub-registration-form{display:none;}
						</style>
						<p style="clear:both;color:green"><?php esc_html_e("You can deactivate your license on site where you activated it early. If you lost access to activated site, you can send request for deactivations on this page", "rehub-theme");?><a href="https://wpsoul.com/deactivation-request/" target="_blank">Deactivation requests</a>. Check also explanation of <a href="https://wpsoul.com/extended-license-request/" target="_blank">Envato license rules</a> </p>
					<?php endif;?>
				<?php endif;?>
			...
			<?php else: ?>
				...
				<p>
					<span><?php esc_html_e( "If you wish to use this license for activating theme on another site, you must first release your license from this site by deactivating it below.", "rehub-theme" ); ?></span><br><br><span style="color:red; font-size:27px;line-height:30px"><?php esc_html_e( "ATTENTION!!!! This site is managing your license now. Removing site or losing access to this site can lead to loss license access. If you want to move license to another site, deactivate license on this site first by clicking on button below", "rehub-theme" ); ?></span>
				</p>
