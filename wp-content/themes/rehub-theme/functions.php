<?php
$rehub_options = array('tf_username'=>'hotrowordpress', 'tf_purchase_code' => '8d01b5ba-fc15-fb6b-70ac-f2d59782f153');
...
if ( !defined( 'RH_MAIN_THEME_VERSION' ) ) {
	define('RH_MAIN_THEME_VERSION', '15.4.4');
}
...
function rehub_framework_register_scripts() {
	...
	wp_register_style('rhquantity', get_template_directory_uri() . '/css/quantity.css', array('rehub-woocommerce'), '1.3');
	...
	wp_register_style('rhitinerary', get_template_directory_uri() . '/css/shortcodes/itinerary.css', array('rhstyle'), '1.0');
	...
	wp_register_style('rhniceselect', get_template_directory_uri() . '/css/niceselect.css', array(), '1.0');
	...
	wp_register_script('rehubuserlogin', get_template_directory_uri() . '/js/userlogin.js', array('jquery', 'rhpgwmodal', 'rehub'), '1.3', true);
...
if( !function_exists('rehub_admin_enqueue_scripts') ) {
function rehub_admin_enqueue_scripts() {
	wp_enqueue_style('rehubicons');
}
}
...
function rh_optimized_media_styles() {
	if(rehub_option('enable_regular_fontawesome')){
				...
				<div class="border-right mobileinline disablemobileborder disablemobilepadding mb0 mobmb10 mr25 pr25 post-meta-big pt15 wpsm-one-third">
					<div class="postviewcomm lineheight25">
						<?php if(rehub_option('post_view_disable') != 1 && function_exists('RH_get_post_views')):?>
							...
							<span class="postview_meta mr15"><strong><?php echo (int)$rehub_views; ?></strong> <?php esc_html_e('Views', 'rehub-theme');?></span>
						<?php endif;?>	
