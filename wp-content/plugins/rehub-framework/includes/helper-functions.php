...
//////////////////////////////////////////////////////////////////
// WEBP support until WP will have it
//////////////////////////////////////////////////////////////////
...
function rh_reusable_screen_fill_column( $column, $ID ) {
	...
	switch( $column ) {
		case 'rh-reusable-shortcode' :
			echo '<input type="text" style="width:230px" value="[wp_reusable_render id=' . $ID . ']" readonly="">';
			break;
		default :
			break;
	}
}
function wp_reusable_render( $atts ){
...
add_shortcode( 'wp_reusable_render', 'wp_reusable_render' );
