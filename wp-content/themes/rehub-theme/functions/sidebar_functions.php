									...
									<div class="rh-deal-btn mb10 text-right-align">
										<?php if($offer_coupon_mask && $offer_coupon):?>
								    		<div class="post_offer_anons">
							                	...
							                	<span class="coupon_btn rehub_offer_coupon mr0 re_track_btn btn_offer_block rh-deal-compact-btn padforbuttonsmall fontnormal font95 lineheight15 text-center inlinestyle masked_coupon <?php if(!empty($offer_coupon_date)) {echo ''.$coupon_style ;} ?>" data-clipboard-text="<?php echo esc_html ($offer_coupon) ?>" data-codeid="<?php echo (int)$post->ID?>" data-dest="<?php echo esc_url($offer_url) ?>">
