...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	<div class="shortcode_loop">
		<p><label><?php esc_html_e('Icon', 'rehub-theme'); ?></label><input type="text" name="itinerary-icon" value="" class="itinerary-icon" /><br /><small><?php printf( '%s %s <a href="http://wpsoul.net/icons/" target="_blank">%s</a>', esc_html__('Set icon class without fa-', 'rehub-theme'), esc_html__('Or leave blank.', 'rehub-theme'), esc_html__('More detail...', 'rehub-theme') ); ?></small></p>
