...
if(!function_exists('wpsm_stickypanel_shortcode')) {
    function wpsm_stickypanel_shortcode($atts, $content) {  
        ...
        wp_enqueue_script( 'contentstickypanel', get_template_directory_uri() . '/js/contentstickypanel.js', array( 'jquery', 'rehubwaypoints' ), 1.1, true ); 
        ...
        if($type === 'masonry'){
          ...
          ';           
            ...
            elseif (rehub_option('rehub_third_color')) {
                ...
                $overcolor = hex2rgba($overcoloror, 0.65);
                $overcolorbg = hex2rgba($overcoloror, 0.25);
            }   
            else {
                $overcolor = 'rgb(18 1 94 / 65%)';
                $overcolorbg = '#090425';
            }
            $output .= '
            ...
            $output .= '
              ...
              .woocommerce table.cart a.remove{ display: block; font-size: 32px; height: 1em; width: 1em; text-align: center; line-height: 1; border-radius: 100%; color: red; text-decoration: none; font-weight: bold;margin: 0 auto; }
              .woocommerce table.cart a.remove:hover{ background-color: red; color: #fff; }
              .woocommerce table.cart td.actions { text-align: right; }
              .woocommerce table.cart td.actions .coupon { float: left; }
              .woocommerce table.cart td.actions .coupon label{ display: none; }
              .woocommerce table.cart td.actions .coupon .input-text{ float: left;    box-shadow: inset 0 1px 4px 0 rgba(0,0,0,0.1); -webkit-box-shadow: inset 0 1px 4px 0 rgba(0,0,0,0.1); -moz-box-shadow: inset 0 1px 4px 0 rgba(0,0,0,0.1); border: 1px solid #e0dadf; padding: 6px 6px 5px; margin: 0 4px 0 0; outline: 0; line-height: 1em; }
            ...
            $output .= '
              ...
              .woocommerce #payment ul.payment_methods li{ line-height: 2em; text-align: left; margin: 0; font-weight: normal; list-style: none;}
