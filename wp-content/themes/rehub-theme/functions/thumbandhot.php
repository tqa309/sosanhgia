                ...
                $posttype = $post->post_type;
                   ?>
                    ...
                    <div class="celldisplay pt10 pr15 pb10 pl15 border-grey">
                        ...
                        <?php if((rehub_option('compare_page') || rehub_option('compare_multicats_textarea')) && get_post_type($post->ID) == 'product') :?>           
                            <?php 
                                $cmp_btn_args = array(); 
...
function getShopLikeButton( $user_id ) {
    ...
    if ( AlreadylikedShop( $user_id ) ) { // already liked, set up unlike addon
        $output .= '<span class="favorshop_like"><i class="rhicon rh-heart-solid"></i></span>';
