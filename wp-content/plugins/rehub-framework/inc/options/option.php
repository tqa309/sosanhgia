			...
			'controls' => array(
				array(
					...
					'fields' => array(
						...
						array(
							'type' => 'toggle',
							'name' => 'enable_regular_fontawesome',
							'label' => esc_html__('Enable regular FontAwesome?', 'rehub-framework'),
							'description' => 'By default, theme uses light version of icons <a href="https://wpsoul.net/icons" target="_blank">light version of icons</a>. But you can enable regular FontAwesome. This will reduce speed of site',
							'default' => '0',
						),															
					),
				),				
